...
\begin{equation*}
    \text{positive semi-definite: }\forall\ket{a}\in\mathcal{H}, \expval{\Pi_a}{a},\qquad
    \sum_a \Pi_a = \mathbb{I}.
\end{equation*}
...
\end{align}
POVM, unlike projective measurements, allow one to describe the process of quantum measurement while \textit{ignoring the result}. We can think of it as measuring for a ...