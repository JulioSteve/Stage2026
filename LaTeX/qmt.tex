...
\end{align}
The operator $\Pi_a=K_a^\dagger K_a$ is called the \textit{effect}~\cite{W96} for the result $a$. The set of all effects $\qty{\Pi_a}_a$ forms a POVM\@. Every effect needs to respect the following properties:
\begin{equation*}
