...
\begin{multline}
    \expval{\hat{O}} = \Tr{\rho_{AB}\hat{O}} = \sum_{a=1}^{\mathcal{H}_A}\sum_{b=1}^{\mathcal{H}_B}\bra{\phi_a}\bra{\phi_b}\rho_{AB}\qty(\hat{O}_A\otimes\mathbb{I}_B)\ket{\phi_b}\ket{\phi_a}\\= \sum_{a=1}^{\mathcal{H}_A}\bra{\phi_a}\underbrace{\sum_{b=1}^{\mathcal{H}_B}\bra{\phi_b}\rho_{AB}\ket{\phi_b}}_{\rho_A}\hat{O}_A\ket{\phi_a} = \mathrm{Tr}_A\qty[\rho_A \hat{O}_A].
\end{multline}
