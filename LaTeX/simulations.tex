...
\begin{equation}
    \begin{cases}
        \sqrt{2}\mathrm{Re}\qty{\rho_{eg}(\tau)} = \frac{e^{-\frac{k\tau}{2}}}{\sqrt{2}}\mathrm{cos}(\Omega\tau)\\
        \sqrt{2}\mathrm{Im}\qty{\rho_{eg}(\tau)} = -\frac{e^{-\frac{k\tau}{2}}}{\sqrt{2}}\mathrm{sin}(\Omega\tau)
    \end{cases}.
\end{equation}
...
\begin{equation}
    \alpha(t) = e^{-i\qty(i\omega_0+\frac{k}{2})(t-t_0)} \alpha(t_0).
\end{equation}
...
\end{equation}
Converting once again to dimensionless units and by recognizing the expression of a cosinus, we obtain
\begin{equation}
    \expval{a_\theta(\tau)} = \sqrt{2}\abs{\alpha_0}e^{-\frac{\tau}{2}}\mathrm{cos}\qty(\Omega\tau+\theta).
\end{equation}
...
\begin{equation}
    \begin{cases}
        \expval{a_0(\tau)} = 2\sqrt{2}e^{-\frac{\tau}{2}}\mathrm{cos}\qty(\Omega\tau)\\
        \expval{a_{\pi/2}(\tau)} = -2\sqrt{2}e^{-\frac{\tau}{2}}\mathrm{sin}\qty(\Omega\tau)
    \end{cases}.
\end{equation}
