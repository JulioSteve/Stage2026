...
\begin{equation}
    \boxed{\dert{A_H} = \frac{i}{\hbar}\left[H_{H},A_{H}\right] + \qty(\derpart{A_S})_H\label{eq:HSlink}},
\end{equation}
where $(\derpart{A_S})_H=U^\dagger(t,t_0)\derpart{A_S(t)}U(t,t_0)$. We observe in particular that if the observable does not depend explicitly on time, the last term is zero.
