ENV["GKSwstype"] = "100"
using QuantumToolbox, Plots, LaTeXStrings, Printf, Random, Distributions, Base.Threads
theme(:dao)
...
Time_to_exec = zeros(100)
for ntraj in 1:100
    t_iter = @elapsed begin
        sim(ntraj, 0.0)
    end
    Time_to_exec[ntraj] = t_iter
end

Ptest = plot(1:100, Time_to_exec)
